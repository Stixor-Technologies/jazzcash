...
#     "Account_Creation_Date": st.text_input("Date Account_Creation_Date", "2021-05-12 21:26:26"),
...
transaction_data = {
    ...
    "Account_Creation_Date": st.text_input("Date Account_Creation_Date", "2021-03-12 21:26:26"),
    ...
    "Channel": st.selectbox("Channel", ['Mobile Payments', 'Credit Card', 'Debit Card', 'E-Wallet',
       'Bank Transfer'], index = 0),
    ...
    with st.spinner("Sending data to model..."):
        try:
            ...
            if response.status_code == 200:
                ...
                st.subheader("Business Rule Flags")
                ...
                # Show Statistical Rule Flags
                st.subheader("Statistical Rule Flags")
